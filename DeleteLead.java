...
public class DeleteLead extends ProjectrelatedMethods {
	@DataProvider(name = "DataProvider_DeleteLead")
...
@Test(dataProvider="DataProvider_DeleteLead", priority = 2 ,dependsOnMethods = "week2.assignments.DuplicateLead.tc003")
